			...
			<div class="row">
				...
				<div class="col-xs-8 text-right">
					...
					<div class="input-group col-xs-4 float-right">
						<span class="input-group-addon">Invoice No.<?php echo INVOICE_PREFIX ?></span>
						<input type="text" readonly name="invoice_id" id="invoice_id" class="form-control required" placeholder="Invoice Number" aria-describedby="sizing-addon1" value="<?php getInvoiceId(); ?>">
					</div>
				</div>
			</div>
			<div class="row">
